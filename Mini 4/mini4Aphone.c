...
/**
 * This is a C file containing the functions used by mini4Amain.c.
 ...
 * @return 0 - Success
 *         1 - Error no file
 *         2 - Error while loading file
 */
int loadCSV(int *numberOfRecords)
{
	// Open file
	FILE *phonebookCSV;
	...
	for (int i = 0; i < 10 && !feof(phonebookCSV); i++)
	{
		// Read file
		fscanf(phonebookCSV,
					 "%49[^,],%11[^,],%14[^\n]\n",
 ...
 */
int addRecord(int *numberOfRecords, char *name, char *birthdate, char *phone)
{
